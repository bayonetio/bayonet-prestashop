...
class AdminBayonetOrdersController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = [
            'bayonet_id' => [
                ...
                'remove_onclick' => true,
                'hint' => $this->context->getTranslator()->trans(
                    'The ID of this table',
                    [],
                    'Modules.Bayonetantifraud.Adminbayonetorders'
                ),
            ],
            'cart_id' => [
                'title' => $this->context->getTranslator()->trans(
                    'Cart',
                    [],
                    'Modules.Bayonetantifraud.Adminbayonetorders'
                ),
                ...
                'remove_onclick' => true,
                'hint' => $this->context->getTranslator()->trans(
                    'The cart associated to this order',
                    [],
                    'Modules.Bayonetantifraud.Adminbayonetorders'
                ),
            ],
            ...
            'bayonet_tracking_id' => [
                ...
                'orderby' => false,
                'hint' => $this->context->getTranslator()->trans(
                    'An ID generated by the Bayonet API for this transaction',
                    [],
                    'Modules.Bayonetantifraud.Adminbayonetorders'
                ),
            ],
            'decision' => [
                ...
                'remove_onclick' => true,
                'hint' => $this->context->getTranslator()->trans(
                    'The actual decision obtained after the order analysis,
                    this is what you use to decide what to do with an order, if an order has DECLINE in this field,
                    you should cancel it right away',
                    [],
                    'Modules.Bayonetantifraud.Adminbayonetorders'
                ),
            ],
     ...
     * @param array $row
     */
    public function viewOrder($value, $id_customer)
    {

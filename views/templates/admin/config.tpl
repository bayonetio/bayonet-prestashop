...
<div class="panel">
	...
	<br />
	<br />
	{l s='If you need any support regarding this module, you can contact us using the' mod='bayonetantifraud'} <a href="https://addons.prestashop.com/contact-form.php?id_product=85390" target="_blank" rel="noopener noreferrer">{l s='PrestaShop support URL' mod='bayonetantifraud'}</a>.
	{l s='For any other matter feel free to send an email to' mod='bayonetantifraud'} <a href="mailto:prestashop@bayonet.io">prestashop@bayonet.io</a> {l s=' or contact us via Intercom on our ' mod='bayonetantifraud'} <a href="https://bayonet.io/" target="_blank" rel="noopener noreferrer">{l s='Website' mod='bayonetantifraud'}</a>{l s='.' mod='bayonetantifraud'}
</div>

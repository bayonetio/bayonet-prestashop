...
class BayonetDb
{
    ...
    public static function createTables()
    {
        ...
        $sqlQueries[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'bayonet_antifraud_orders` (
            ...
            `triggered_rules` varchar(2000) NULL,
        ...
        $sqlQueries[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'bayonet_antifraud_backfill` (
            `backfill_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
            `backfill_status` tinyint(1) default 0 NOT NULL,
            `processed_orders` int(10) unsigned NOT NULL DEFAULT 0,
